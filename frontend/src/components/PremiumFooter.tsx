  ...
  return (
    <footer ref={ref} className={styles.footer}>
      ...
      <div className={styles.container}>
        {/* ── TOP: Brand + contact cards + newsletter ── */}
        <motion.div
        ...
        >
          ...
          <div className={styles.brand}>
            ...
            <p className={styles.brandTagline}>
              ...
              and clinical education. Precision in every model.
            </p>
            {/* Social icons */}
          ...
          <div className={styles.rightBlock}>
            ...
            <div className={styles.newsletterBlock}>
              <div className={styles.newsletterTitle}>Stay Updated</div>
              <p className={styles.newsletterDesc}>
                Get the latest products & medical education insights.
              </p>
              <NewsletterInput />
            </div>
          </div>
          ...
          >
            ...
            <div className={styles.certBadges}>
              {['ISO 9001', 'CE Marked', 'FDA Approved', 'WHO Listed'].map((cert) => (
                <div key={cert} className={styles.certBadge}>{cert}</div>
              ))}
            </div>
            <p className={styles.certNote}>
              All products meet international medical safety and quality standards.
            </p>
          </motion.div>
        </div>
